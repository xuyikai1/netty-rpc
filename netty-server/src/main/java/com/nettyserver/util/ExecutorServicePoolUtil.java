 ...
 */
public class ExecutorServicePoolUtil {
    ...
    public static ExecutorService createThreadPool(
        ...
        executorService =
                new ThreadPoolExecutor(
                        ...
                        factory,
                        new ExecutorServicePoolUtil.MyAbortPolicy());
    ...
    public static void main(String[] args) {
        ExecutorService threadPool = ExecutorServicePoolUtil.createThreadPool(
